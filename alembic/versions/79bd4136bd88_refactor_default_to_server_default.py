"""Refactor default to server_default

Revision ID: 79bd4136bd88
Revises: e6b4ffcfdfbd
Create Date: 2025-11-27 16:19:46.302379
...
revision: str = '79bd4136bd88'
down_revision: Union[str, None] = 'e6b4ffcfdfbd'
...
def upgrade() -> None:
    ...
    sa.Column('costo', sa.Float(precision=10, asdecimal=2), nullable=True),
    ...
    sa.Column('opcionPago', sa.Enum('EFECTIVO', 'TARJETA', 'TRANSFERENCIA', name='opcionpagoenum'), nullable=True),
    sa.Column('registro', sa.DateTime(), nullable=False),
